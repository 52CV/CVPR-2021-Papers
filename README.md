...
|----|-----|----|-----|-----|
|#|#|#|[22.医学影像](#22)|[21.Transformer](#21)|
|[20.人员重识别](#20)|[19.模型压缩](#19)|[18.航空影像](#18)|[17.超分辨率](#17)|[16.视觉问答](#16)|
|[15.GAN](#15)|[14.少样本学习](#14)|[13.图像检索](#13)|[12.图像质量](#12)|[11.人脸技术](#11)|
...
- [Transformer Interpretability Beyond Attention Visualization](https://arxiv.org/pdf/2012.09838.pdf)<bar>[code](https://github.com/hila-chefer/Transformer-Explainability)<br>
...
- [Learning Student Networks in the Wild](https://arxiv.org/pdf/1904.01186.pdf)<br>[code](https://github.com/huawei-noah/DAFL)<br>
- [Rethinking Channel Dimensions for Efficient Model Design](https://arxiv.org/abs/2007.00992)<br>[code](https://github.com/clovaai/rexnet)<br>
...
- 【AdderSR: Towards Energy Efficient Image Super-Resolution](https://arxiv.org/pdf/2009.08891.pdf)<br>[code](https://github.com/huawei-noah/AdderNet)<br>
...
- [Encoding in Style: a StyleGAN Encoder for Image-to-Image Translation](https://arxiv.org/abs/2008.00951)<br>[code](https://github.com/eladrich/pixel2style2pixel)|[project](https://eladrich.github.io/pixel2style2pixel/)<br>
...
[Multi-Stage Progressive Image Restoration](https://arxiv.org/abs/2102.02808)<br>[code](https://github.com/swz30/MPRNet)<br>
...
- [Multiple Instance Active Learning for Object Detection](https://github.com/yuantn/MIAL/raw/master/paper.pdf)<br>[code](https://github.com/yuantn/MIAL)<br>
- Positive-Unlabeled Data Purification in the Wild for Object Detection<br>
- Open-world object detection(开放世界中的目标检测)<br>[code](https://github.com/JosephKJ/OWOD)<br>
...
- [Weakly Supervised Learning of Rigid 3D Scene Flow](https://arxiv.org/pdf/2102.08945.pdf)<br>[code](https://arxiv.org/pdf/2102.08945.pdf)|[project](https://3dsceneflow.github.io/)<br>

<a name="3"/> 

## 3.点云

-[PREDATOR: Registration of 3D Point Clouds with Low Overlap](https://arxiv.org/pdf/2011.13005.pdf)<br>[code](https://github.com/ShengyuH/OverlapPredator)|[project](https://overlappredator.github.io/)<br>
...
- [Instance Localization for Self-supervised Detection Pretraining](https://arxiv.org/pdf/2102.08318.pdf)<bar>[code](https://github.com/limbo0000/InstanceLoc)<br>
- [FLAVR: Flow-Agnostic Video Representations for Fast Frame Interpolation](https://arxiv.org/pdf/2012.08512.pdf)<bar>[code](https://tarun005.github.io/FLAVR/Code)|[project](https://tarun005.github.io/FLAVR/)<br>
- [Re-labeling ImageNet: from Single to Multi-Labels, from Global to Localized Labels](https://arxiv.org/abs/2101.05022)<bar>[code](https://github.com/naver-ai/relabel_imagenet)<br>
...
- [IIRC: Incremental Implicitly-Refined Classification](https://arxiv.org/abs/2012.12477)<br>[project](https://chandar-lab.github.io/IIRC/)<br>
- [Fair Attribute Classification through Latent Space De-biasing](https://arxiv.org/abs/2012.01469)<bar>[code](https://github.com/princetonvisualai/gan-debiasing)|[project](https://princetonvisualai.github.io/gan-debiasing/)<br>
...
- Less is More: CLIPBERT for Video-and-Language Learning via Sparse Sampling(T通过稀疏采样进行视频和语言学习)<br>[paper](https://arxiv.org/pdf/2102.06183.pdf)|[code](https://github.com/jayleicn/ClipBERT)<br>
- [3D CNNs with Adaptive Temporal Feature Resolutions](https://arxiv.org/abs/2011.08652)<br>
- [D-NeRF: Neural Radiance Fields for Dynamic Scenes](https://arxiv.org/abs/2011.13961)<br>[project](https://www.albertpumarola.com/research/D-NeRF/index.html)<br>
...
- [RepVGG: Making VGG-style ConvNets Great Again](https://arxiv.org/abs/2101.03697)<bar>[code](https://github.com/megvii-model/RepVGG)<br>
